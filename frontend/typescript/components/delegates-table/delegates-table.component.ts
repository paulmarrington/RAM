...
@Component({
    selector: "ram-delegates-relationship-table",
    templateUrl: "delegates-table.component.html",
    providers: [FORM_DIRECTIVES]
})
export class DelegatesTableComponent implements OnInit {
    ...
    refreshContents(relIds: string[]) {
        ...
        let response = this.rest.getDelegateTableData(
